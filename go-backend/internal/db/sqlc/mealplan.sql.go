...
func (q *Queries) CreateMealPlan(ctx context.Context, arg CreateMealPlanParams) (CreateMealPlanRow, error) {
	row := q.db.QueryRowContext(ctx, createMealPlan,
		arg.UserID,
		arg.Column2,
		arg.Name,
		arg.MealTimeID,
...
func (q *Queries) CreateMealTime(ctx context.Context, arg CreateMealTimeParams) (CreateMealTimeRow, error) {
	row := q.db.QueryRowContext(ctx, createMealTime,
		arg.UserID,
		arg.Name,
		arg.Column3,
		arg.Column4,
...
func (q *Queries) DeleteMealPlan(ctx context.Context, arg DeleteMealPlanParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteMealPlan, arg.ID, arg.UserID)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) DeleteMealTime(ctx context.Context, arg DeleteMealTimeParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteMealTime, arg.ID, arg.UserID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) EnsureDefaultMealTime(ctx context.Context, arg EnsureDefaultMealTimeParams) error {
	_, err := q.db.ExecContext(ctx, ensureDefaultMealTime, arg.Name, arg.Column2, arg.Column3)
	return err
}
...
func (q *Queries) GetMealPlanForUpdate(ctx context.Context, arg GetMealPlanForUpdateParams) (GetMealPlanForUpdateRow, error) {
	row := q.db.QueryRowContext(ctx, getMealPlanForUpdate, arg.ID, arg.UserID)
...
func (q *Queries) GetMealTimeRange(ctx context.Context, arg GetMealTimeRangeParams) (GetMealTimeRangeRow, error) {
	row := q.db.QueryRowContext(ctx, getMealTimeRange, arg.ID, arg.UserID)
...
func (q *Queries) ListMealPlansByDate(ctx context.Context, arg ListMealPlansByDateParams) ([]ListMealPlansByDateRow, error) {
	rows, err := q.db.QueryContext(ctx, listMealPlansByDate, arg.UserID, arg.Column2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListMealPlansByRange(ctx context.Context, arg ListMealPlansByRangeParams) ([]ListMealPlansByRangeRow, error) {
	rows, err := q.db.QueryContext(ctx, listMealPlansByRange, arg.UserID, arg.Column2, arg.Column3)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListMealTimes(ctx context.Context, userID sql.NullInt64) ([]ListMealTimesRow, error) {
	rows, err := q.db.QueryContext(ctx, listMealTimes, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListRecentMealPlans(ctx context.Context, userID int64) ([]ListRecentMealPlansRow, error) {
	rows, err := q.db.QueryContext(ctx, listRecentMealPlans, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) SetMealPlanConsumed(ctx context.Context, arg SetMealPlanConsumedParams) (SetMealPlanConsumedRow, error) {
	row := q.db.QueryRowContext(ctx, setMealPlanConsumed, arg.IsConsumed, arg.ID, arg.UserID)
...
func (q *Queries) UpdateMealPlan(ctx context.Context, arg UpdateMealPlanParams) (UpdateMealPlanRow, error) {
	row := q.db.QueryRowContext(ctx, updateMealPlan,
		arg.Name,
		arg.Column2,
		arg.MealTimeID,
		arg.Column4,
